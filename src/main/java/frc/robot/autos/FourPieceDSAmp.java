...
public class FourPieceDSAmp extends Command {
        ...
        public Command followTrajectory() {
                ...
                return Commands.sequence(
                                ...
                                new ParallelDeadlineGroup(theCMDs[0], new PivotDown(m_pivot),
                                ...
                                // Shoot
                                new ParallelDeadlineGroup(new WaitCommand(0.75),
                                ...
                                new ParallelDeadlineGroup(theCMDs[1], new PivotDown(m_pivot),
                                                new NoteIntake(m_intake, m_feeder, l_candle), new WaitCommand(2)),
                                new InstantCommand(() -> s_swerve.drive(
                                                new Translation2d(0, 0),
                                                0,
                                ...
                                // Shoot
                                new ParallelDeadlineGroup(new WaitCommand(0.8),
                                                new NoteIntake(m_intake, m_feeder, l_candle)),
                                new ParallelDeadlineGroup(
                                                new WaitCommand(2.5),
                                                new SpeakerShootForAuto(m_shooter, m_pivot, m_feeder, l_candle),
