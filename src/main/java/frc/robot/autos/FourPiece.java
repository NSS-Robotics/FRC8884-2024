...
public class FourPiece extends Command {
        ...
        public Command followTrajectory() {
                ...
                return Commands.sequence(
                                ...
                                new ParallelDeadlineGroup(theCMDs[0], new NoteIntake(m_intake, m_feeder, l_candle),
                                                new WaitCommand(2)),
                                ...
                                new ParallelDeadlineGroup(theCMDs[1], new NoteIntake(m_intake, m_feeder, l_candle),
                                                new WaitCommand(2)),
                                new InstantCommand(() -> s_swerve.drive(
                                                new Translation2d(0, 0),
                                                0,
                                ...
                                new ParallelDeadlineGroup(theCMDs[2], new NoteIntake(m_intake, m_feeder, l_candle),
                                                new WaitCommand(2)),
                                new InstantCommand(() -> s_swerve.drive(
                                                new Translation2d(0, 0),
                                                0,
